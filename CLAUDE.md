...
make EXTENSION=odh-jupyter-trash-cleanup lint         # Runs all linters and auto-fixes
...
For active development with live changes:
...
# Manually enable server extension in develop mode
jupyter server extension enable odh_jupyter_trash_cleanup

# Build and watch in separate terminals
jlpm watch                 # Terminal 1: auto-rebuild on changes
